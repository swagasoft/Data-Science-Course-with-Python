...
def get_filters():
	...
	"""
	while True:
		city = input("Please specify which city you're interested in: Chicago, New York City, or Washington. ").strip().strip("'").lower()
		if city == 'chicago' or city == 'new york city' or city == 'washington':
			break
		else:
			print("That's not a valid city name!")
	while True:
		month = input("Are you interested in analyzing data for a specific month? If so, please enter its full name (e.g. January, February). If not, enter 'all': ").strip().strip("'").lower()
		if month == 'january' or month == 'february' or month == 'march' or month == 'april' or month == 'may' or month == 'june' or month == 'all':
			break
		else:
			print("That's not a valid month name!")
	while True:
		day = input("Are you interested in analyzing data for a specific day of the week? If so, please enter its full name (e.g. Monday, Tuesday). If not, enter 'all': ").strip().strip("'").lower()
