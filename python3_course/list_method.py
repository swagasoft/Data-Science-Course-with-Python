...
# determined depends on what type objects are in the list. The maximum element in a list
#  of numbers is the largest number. The maximum elements in a list of strings is element 
#  that would occur last if the list were sorted alphabetically. This works because the
